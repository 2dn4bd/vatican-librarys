...
const BookCollectionDisplay = ({booksCollection}) => {
    const {name, image, author, category_name, rating, _id, quantity} = booksCollection || {}
    return (
...
export default BookCollectionDisplay;